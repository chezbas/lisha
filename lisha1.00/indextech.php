	...
	<head>
		...
		<?php 
			 ...
			 * MagicTree definition of each tree in page
			 ====================================================================*/	
			include ('includes/MTSetup/define/MT_tech_doc.php');
			...
			/*===================================================================*/
			?>
		<title><?php echo str_replace('&1',__LISHA_APPLICATION_NAME__,$_SESSION[$ssid]['lisha']['page_text'][2]['TX']);?> </title>
	</head>
	<body onload="init_load('<?php echo $_SESSION[$ssid]['lisha']['langue_TinyMCE'];?>','<?php echo $id_page;?>');<?php echo 'MagicTree_'.$mt_tech_id.'()'?>;">
		<!-- ================================================== MSGBOX ================================================= -->	
		...
		<div id="main_details" style="float: right;">
			<div id="headdetails" class="headdetails" <?php if(!$_SESSION[$ssid]['MT']['tree']['id']['ikdoc']["edit_mode"]) echo 'onclick=\'MainTimer.add_event(1,"reduce_tool_bar()");\'';echo 'MagicTree_'.$mt_tech_id.'();';?> style="height: 0px;">
				<?php
				echo '<div class="welcome">'.str_replace('&1',__LISHA_APPLICATION_NAME__,$_SESSION[$ssid]['lisha']['page_text'][2]['TX']).'</div>';
				if($_SESSION[$ssid]['MT']['tree']['id']['ikdoc']["edit_mode"])
				{
				echo '
