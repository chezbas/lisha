...
<html>
	<head>
		...
		<?php 
			 ...
			 * MagicTree definition of each tree in page
			 ====================================================================*/	
			include ('./includes/MTSetupDoc/define/MT_user_doc.php');
	...
	<body onload="init_load('<?php echo $_SESSION[$ssid]['MT']['langue_TinyMCE'];?>','<?php echo $id_page;?>');<?php echo 'MagicTree_'.$mt_user_id.'()'?>;">
		<!-- ================================================== MSGBOX ================================================= -->	
		<div id="iknow_msgbox_background"></div>
		<div id="iknow_msgbox_conteneur" style="display:none;"></div>
		<!-- ===============================================  END MSGBOX ==============================================  -->
		<?php echo '<div id="'.$mt_user_id.'" style="position: absolute; top:0; left:0; height:100%; width:500px; font-size: 0.9em; box-shadow: 5px 2px 8px #333;"></div>';?>
		<div id="gauche" style="float: left; width:30%; height:100%; display:block;"></div>
		<div id="main_details" style="float: left;">
			<div id="headdetails" class="headdetails" <?php if(!$_SESSION[$ssid]["edit_mode"]) echo 'onclick=\'MainTimer.add_event(1,"reduce_tool_bar()");\'';echo 'MagicTree_'.$mt_user_id.'();';?> style="height: 0px;">
				<?php
