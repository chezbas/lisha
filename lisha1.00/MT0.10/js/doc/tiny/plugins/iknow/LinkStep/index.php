...
<html>
	<head>
		...
		<?php 
			 ...
			 * Vimofy init
			 ====================================================================*/	
			require('../../../../../../includes/ifiche/vimofy/edit/tiny/vim_link_step.php');
			/*===================================================================*/	
			
			echo '<title>'.$_SESSION[$ssid]['message'][145].'</title>';
			/*==================================================================
			* Vimofy internal init
			====================================================================*/  
			$_SESSION['vimofy'][$ssid]['vim_link_step_tiny']->generate_public_header();   
			$_SESSION['vimofy'][$ssid]['vim_link_step_tiny']->vimofy_generate_header();
			/*===================================================================*/    
		?>
	...
	<body style="font-size:16px;" onmousemove="vimofy_move_cur(event);" onmouseup="vimofy_mouseup();">
		<div class="bloc">
			<div style="width:100%;bottom:0;top:0;position:absolute;background-color:#999;" id="vim_varin_tiny">
				<?php echo $_SESSION['vimofy'][$ssid]['vim_link_step_tiny']->generate_vimofy(); ?>
			</div>
		</div>
		<?php 
			$_SESSION['vimofy'][$ssid]['vim_link_step_tiny']->vimofy_generate_js_body();
		?>
	</body>
</html>