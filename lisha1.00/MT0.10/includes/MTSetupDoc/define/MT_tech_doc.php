<?php
	...
	//==================================================================
	$obj_tech_doc->define_attribute('__node_table_name', 'MT_mt_doc_tech');
	$obj_tech_doc->define_attribute('__caption_table_name', 'MT_mt_doc_tech_caption');
	...
	//==================================================================
	$obj_tech_doc->define_attribute('__language_id', 'ENG');
	//==================================================================
	...
	//==================================================================
	$obj_tech_doc->define_attribute('__active_edit', $_SESSION[$ssid]["edit_mode"]);
	//==================================================================
