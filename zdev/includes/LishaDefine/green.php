<?php 
	...
	//==================================================================
		...
		//==================================================================
		$obj_lisha_tran->define_column('`zdev_table`.description','description','Caption',__TEXT__,__WRAP__,__LEFT__);
		...
		//==================================================================
		$obj_lisha_tran->define_column('`zdev_table`.amount','amount','normal',__TEXT__,__WRAP__,__LEFT__);
