<?php 
	...
	$obj_lisha_tran->define_attribute('__title', 'Red theme demo');							// Title
	...
	//==================================================================
		...
		// define column : Date modification
		//==================================================================
		$obj_lisha_tran->define_column('`demo_table`.`otherdate`','otherdate','Date Time !!',__DATE__,__WRAP__,__CENTER__,__PERCENT__,__DISPLAY__);
		...
		//==================================================================
		$obj_lisha_tran->define_column("DECODE(`demo_table`.`password`,'hX*sqdkjf3_--é0Fz.')",'password','Encode/Decode',__TEXT__,__WRAP__,__LEFT__);
		...
		$obj_lisha_tran->define_col_select_function('password',"DECODE(`demo_table`.__COL_VALUE__,'hX*sqdkjf3_--é0Fz.')");
		//==================================================================

		//==================================================================
		// define column : Description
		//==================================================================
		$obj_lisha_tran->define_column('`demo_table`.`description`','description','Caption',__BBCODE__,__WRAP__,__LEFT__);
		...
		//==================================================================
		$obj_lisha_tran->define_column('`demo_table`.`amount`','amount','normal',__BBCODE__,__WRAP__,__LEFT__);
